...
contract Raffle is VRFConsumerBaseV2Plus {
     ...
     * if the loterry is ready for a new winner.
     * The following should be true in order for upkeepNedded to be true:
     * 1. The time interval has passed between raffle runs
     * 2.The lottery is open
     * 3. The contract has ETH
     * 4. Also the subscription has LINK
     * @param -ignored
     * @return upkeepNeeded -true if conditions are satisfied
     * @return -ignored
     */
        ...
        returns (bool upkeepNeeded, bytes memory /* performData */ )
    {
        ...
        upkeepNeeded = (timeHasPassed && raffleIsOpen && enoughEth && hasPlayers);
    ...
    function hasPlayer() external view returns (bool) {
